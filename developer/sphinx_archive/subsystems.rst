.. Archived copy of a former public Sphinx page (moved 2026-09).
   The live docs keep an :orphan: stub under docs/source/development/
   so old URLs do not 404. This file is the full original body for
   maintainers (v0.1 / compat / YAML lifecycle notes).
Subsystems
==========
...
.. note::
   ...
   * Habitat studies: ``habit.recipes.Study`` (``fit`` / ``fit_predict`` /
     ``predict``; factories ``two_step_habitat`` / ``one_step_habitat`` /

.. Archived copy of docs/source/customization/index.rst before the 2026-09
   Extending HABIT slim-down. The live page keeps the v1 habitat registry
   path. This file retains the v0.1 PreprocessorFactory / ModelFactory /
   SelectorRegistry / ClusteringAlgorithmFactory tours.
...
**v1.0 (preferred) 鈥?protocol registries**
...
**v0.1 (legacy, still honoured) 鈥?factory registries**

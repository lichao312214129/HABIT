...
Habitat feature contrast (heatmap / Cliff's delta / violin / bars)
------------------------------------------------------------------

After an ``each_habitat`` (or any wide ``habitat_{id}_{feature}``) table,
:func:`~habit.compare_habitat_features` plus the four
``plot_habitat_feature_*`` helpers are the reviewer figures. Bars are
**faceted by feature** so Energy and ``volume_fraction`` do not share one
linear y-axis. Regenerated by
...
.. figure:: ../_static/images/examples/habitat_feature_effect.png
   ...
   Cliff's delta (:func:`~habit.viz.plot_habitat_feature_effect`).

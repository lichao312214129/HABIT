...
- **Adding a method**:
  ...
  2. Register the method name in ``habit/schemas/workflows/habitat.py`` (``PreprocessingMethod.method`` Literal) or rely on schema extension hooks documented in :doc:`../customization/index`

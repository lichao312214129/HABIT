...
# Import feature extraction utility functions to display available feature extractors
from habitat_analysis.features.base_feature_extractor import get_available_feature_extractors
# Import clustering algorithm utility functions to display available clustering algorithms
from habitat_analysis.clustering.base_clustering import get_available_clustering_algorithms
...
if __name__ == "__main__":
    ...
    # if len(sys.argv) == 1:
    #     # 添加默认的配置文件路径，方便调试
    #     sys.argv.extend(["--config", "./config_kmeans.yaml", "--debug"])

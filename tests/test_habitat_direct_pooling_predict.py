"""
Test cases for habit get-habitat command - direct-pooling predict mode
...
class TestHabitatDirectPoolingPredict:
    """Test cases for get-habitat command with direct-pooling predict mode"""
    
    def test_direct_pooling_predict_with_config(self):
        """Test direct-pooling predict with valid config file"""
    ...
    def test_direct_pooling_predict_with_pipeline_override(self):
        """Test direct-pooling predict with pipeline path override"""
        config_path = Path(__file__).parent.parent / 'demo_data' / 'config_habitat_direct_pooling_predict.yaml'
        ...
        # Pipeline is saved in out_dir, which is ./results/habitat_direct_pooling (relative to project root)
        # When running from project root, the path should be results/habitat_direct_pooling/habitat_pipeline.pkl
        pipeline_path = Path(__file__).parent.parent / 'results' / 'habitat_direct_pooling' / 'habitat_pipeline.pkl'
    ...
    def test_direct_pooling_predict_help(self):
    ...
    def test_direct_pooling_predict_missing_config(self):
        """Test direct-pooling predict with missing config file"""
        runner = CliRunner()
...
if __name__ == '__main__':
    ...
    config_path = './demo_data/config_habitat_direct_pooling_predict.yaml'

...
Run from repository root (py310)::
    ...
    E:\\conda\\mconda\\envs\\py310\\python.exe tests/examples/manual_habitat_direct_pooling.py
"""
...
OUT_DIR: Path = EXAMPLE_OUT / "habitat_direct_pooling"

# --- build HabitatSpec in code (direct pooling: no supervoxel stage) ---
spec = HabitatSpec(

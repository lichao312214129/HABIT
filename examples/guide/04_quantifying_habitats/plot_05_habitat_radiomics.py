...
it is covered in :doc:`/auto_examples/04_quantifying_habitats/plot_04_graph_network_features`.
...
#   :doc:`/auto_examples/04_quantifying_habitats/plot_05_habitat_radiomics`, and

...
# %%
# Save maps, tables, and the model
# --------------------------------
result.save("out/pooled_voxels", write_maps=True)
print("wrote out/pooled_voxels/")
...
#   :doc:`/auto_examples/01_building_habitat_maps/plot_06_atomic_pooled`.

...
Habitat feature contrast (heatmap / Cliff's delta / CVA / violin / bars)
-------------------------------------------------------------------------
...
keeps the top-k by max :math:`|\delta|`. If that heatmap would be too
tall, :func:`~habit.viz.plot_habitat_feature_components` shows the same

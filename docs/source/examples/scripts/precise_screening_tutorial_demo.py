...
if __name__ == "__main__":
    ...
    # same Hungarian pairing habitat_stability uses -- so the same colour
    # is the same habitat. force=True: both fits share a model_id digest.
    # Dice is scored on the original pair after that same pairing.
    aligned_map = align_habitat_map(ref_map, mov_map, force=True)

...
def resolve_config_paths(
    ...
    Example:
        >>> config = load_config('config/preprocessing/config_preprocessing_demo.yaml')
        >>> config = resolve_config_paths(config, 'config/preprocessing/config_preprocessing_demo.yaml')
    """
...
def load_config_with_paths(
    ...
    Example:
        >>> config = load_config_with_paths('config/preprocessing/config_preprocessing_demo.yaml')
    """

...
class WeightedConcatCombinerParams(BaseModel):
    """Constructor parameters for :class:`WeightedConcatCombiner`."""
...
class WeightedConcatCombiner:
    ...
    def __init__(self, weights: Mapping[str, float] = {}) -> None:
        self.weights: Dict[str, float] = {
            str(key): float(value) for key, value in dict(weights).items()
        }
...
class AverageCombinerParams(BaseModel):
    """Constructor parameters for :class:`AverageCombiner`."""
...
CombinerRegistry.register_params_model(
    "weighted_concat", WeightedConcatCombinerParams
)
CombinerRegistry.register_params_model("average", AverageCombinerParams)

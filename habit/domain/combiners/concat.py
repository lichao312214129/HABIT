...
__all__ = ["ConcatCombiner", "ConcatCombinerParams"]


class ConcatCombinerParams(BaseModel):
    """Constructor parameters for :class:`ConcatCombiner` (none)."""
...
CombinerRegistry.register_params_model("concat", ConcatCombinerParams)

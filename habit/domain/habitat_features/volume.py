...
__all__ = ["HabitatVolumeFeatures", "HabitatVolumeFeaturesParams"]


class HabitatVolumeFeaturesParams(BaseModel):
    """Constructor parameters for :class:`HabitatVolumeFeatures` (none)."""
...
HabitatFeatureExtractorRegistry.register_params_model(
    "volume", HabitatVolumeFeaturesParams
)

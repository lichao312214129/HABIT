...
class MeanSupervoxelFeaturesParams(BaseModel):
    """Pydantic parameter model for :class:`MeanSupervoxelFeatures`."""

    model_config = ConfigDict(extra="forbid")

    modality: Optional[str] = None
    source: Literal["working", "original"] = "working"
    as_: Optional[str] = None


class StdSupervoxelFeaturesParams(BaseModel):
    """Pydantic parameter model for :class:`StdSupervoxelFeatures`."""
...
class PercentileSupervoxelFeaturesParams(BaseModel):
    """Pydantic parameter model for :class:`PercentileSupervoxelFeatures`."""

    model_config = ConfigDict(extra="forbid")

    modality: Optional[str] = None
    source: Literal["working", "original"] = "working"
    q: float = Field(default=90.0, gt=0, lt=100)
    as_: Optional[str] = None
...
SupervoxelFeatureExtractorRegistry.register_params_model(
    "mean", MeanSupervoxelFeaturesParams
)
SupervoxelFeatureExtractorRegistry.register_params_model(
    "std", StdSupervoxelFeaturesParams
)
SupervoxelFeatureExtractorRegistry.register_params_model(
    "percentile", PercentileSupervoxelFeaturesParams
)

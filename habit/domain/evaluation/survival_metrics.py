...
SurvivalMetricRegistry.register_params_model("c_index", CIndexMetricParams)
SurvivalMetricRegistry.register_params_model(
    "integrated_brier_score", IntegratedBrierScoreMetricParams
)
SurvivalMetricRegistry.register_params_model(
    "cumulative_dynamic_auc", CumulativeDynamicAucMetricParams
)

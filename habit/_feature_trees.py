...
(:class:`~habit._protocols.VoxelFeatureExtractor` and siblings), so
...
class _FeatureTreeBase:
    ...
    def set_random_state(self, seed: int) -> None:
        ...
        implementing :class:`~habit._protocols.Seedable` receive the
...
def build_voxel_extractor(spec: Any) -> Any:
    ...
    Returns:
        A :class:`~habit._protocols.VoxelFeatureExtractor`.
    """
...
def build_supervoxel_extractor(spec: Any) -> Any:
    ...
    Returns:
        A :class:`~habit._protocols.SupervoxelFeatureExtractor`.
    """
    return _build_extractor(
        spec,
...
def build_habitat_extractor(spec: Any) -> Any:
    ...
    Returns:
        A :class:`~habit._protocols.HabitatFeatureExtractor`.
    """
    return _build_extractor(
        spec,

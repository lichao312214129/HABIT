...
from habit.pipeline import SubjectPipeline, TablePipeline
...
class HabitatComponents:
    ...
    :class:`~habit.pipeline.SubjectPipeline` parameters (assembled
    ...
    Attributes:
        ...
        on_geometry_mismatch: Image/mask geometry policy forwarded to
            :class:`~habit.pipeline.SubjectPipeline` (default
            ``"resample_mask"``).

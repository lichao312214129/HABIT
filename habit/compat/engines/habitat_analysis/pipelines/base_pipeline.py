...
from habit.compat.engines.habitat_analysis.checkpoint.manager import HabitatTrainCheckpoint
    ...
    **Why This Design**:
    ...
    def _describe_group_step_data(data: Any) -> str:
        ...
        if isinstance(data, pd.DataFrame):
            from habit.compat.engines.habitat_analysis.feature_preprocessing.dataframe_utils import (
    ...
    def _process_subjects_parallel(self, X: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        from habit.compat.engines.habitat_analysis.checkpoint.stage import IndividualCheckpointStage

...
class MLConfigurator(BaseConfigurator):
    ...
    def create_evaluator(self, output_dir: Optional[str] = None) -> Any:
        ...
        from habit.compat.engines.machine_learning.evaluation.model_evaluation import (
            MultifileEvaluator,
        )
    ...
    def create_reporter(self, output_dir: Optional[str] = None) -> Any:
        ...
        from habit.compat.engines.machine_learning.reporting.report_exporter import ReportExporter
    ...
    def create_threshold_manager(self) -> Any:
        ...
        from habit.compat.engines.machine_learning.evaluation.threshold_manager import (
            ThresholdManager,
        )
    ...
    def create_plot_manager(self, config: Optional[Any] = None) -> Any:
        ...
        from habit.compat.engines.machine_learning.visualization.plot_manager import PlotManager
    ...
    def create_metrics_store(self) -> Any:
        ...
        from habit.compat.engines.machine_learning.reporting.report_exporter import MetricsStore
    ...
    def create_model_comparison(
        ...
        from habit.compat.engines.machine_learning.workflows.comparison_workflow import (
            ModelComparison,
        )
    ...
    def create_ml_workflow(self, config: Optional[Any] = None) -> Any:
        ...
        """
        from habit.compat.engines.machine_learning.workflows.holdout_workflow import (
            HoldoutWorkflow,
        )
    ...
    def create_kfold_workflow(self, config: Optional[Any] = None) -> Any:
        ...
        from habit.compat.engines.machine_learning.workflows.kfold_workflow import (
            KFoldWorkflow,
        )

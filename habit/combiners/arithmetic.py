...
from habit.combiners._base import block_sources, check_blocks
...
class RatioCombiner:
    ...
    Args:
        eps: Constant added to the denominator before dividing. Must be
            non-negative.
    """
    ...
    def __init__(self, eps: float = 1e-8) -> None:
        ...
        if eps_value < 0.0:
            raise HABITAPIError(
                f"ratio: eps must be >= 0, got {eps_value}."
            )
        self.eps = eps_value

...
:class:`~habit._table_protocols.FeatureSelector` protocol: ``fit``
...
from habit.feature_selection._base import (
    FittedSelectorBase,
    outcome_series,
)
from habit.feature_selection.registry import FeatureSelectorRegistry
from habit.evaluation.statistics import repeat_measurement_matrix
...
class UnivariateCoxSelector(FittedSelectorBase):
    ...
    def fit(
        ...
        *,
        ...
        from habit.pipeline.outcome_access import survival_target

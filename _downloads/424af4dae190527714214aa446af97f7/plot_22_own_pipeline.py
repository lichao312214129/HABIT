...
:doc:`/auto_examples/02a_data_in/plot_01_directory` is shorter.
...
# :doc:`/auto_examples/01_complete/plot_01_two_step_spec`. ``Study`` only
...
spec = HabitatSpec(
    ...
    stages=(
        ...
        # subject-level: clip to each patient's 5th..95th percentile, then 0..1.
...
directory_result = Study(spec).fit_predict(directory_cohort)
...
#   :doc:`/auto_examples/02a_data_in/plot_02_simpleitk` and
#   :doc:`/auto_examples/02a_data_in/plot_03_numpy_arrays`.

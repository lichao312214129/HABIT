...
:doc:`/auto_examples/01_complete/plot_01_two_step_spec` on the
...
# How many habitats
# -----------------
# With one feature the elbow curve can bend at a different count than
# the four-phase analysis. Read the chosen K from the model rather than
# assuming it.
print("habitats chosen by the elbow rule:", result.habitat_model.n_habitats)
